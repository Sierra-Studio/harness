...
class HttpMcpClient:
    ...
    def __init__(
        ...
        self._client: Any = None  # httpx.Client (optional dependency)
        self._id = 0
    ...
    def _request(self, method: str, params: dict, _retried: bool = False) -> Any:
        ...
        with self._client.stream("POST", self.url, json=payload, headers=self._headers()) as r:
    ...
    def _authorize(self, www_authenticate: str) -> None:
        ...
        token = OAuthClient(self._client, self._oauth_cfg).get_token(self.url, www_authenticate)
